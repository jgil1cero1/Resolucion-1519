...
(function($, window, document, undefined) {
    ...
    Video.prototype.loadVideo = function(src, addClass, noposter, index, html) {
        ...
        if (isVideo.youtube) {
            ...
            video = '<iframe class="lg-video-object lg-youtube ' + addClass + '" width="560" height="315" src="//www.youtube.com/embed/' + isVideo.youtube[1] + a + '&fs=0" frameborder="0" allowfullscreen></iframe>';
